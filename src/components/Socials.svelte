...
<a href="https://github.com/SebastianBr11/Astro-Pokemon-Test" aria-label="Link to Github Profile">
	<svg class="text-[#231e1b] dark:text-white" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
	 xmlns:a="http://ns.adobe.com/AdobeSVGViewerExtensions/3.0/" x="0px" y="0px" width="32.6px" height="31.8px" viewBox="0 0 32.6 31.8"
	 xml:space="preserve">
		<defs>
		</defs>
		<path fill="currentColor" d="M16.3,0C7.3,0,0,7.3,0,16.3c0,7.2,4.7,13.3,11.1,15.5c0.8,0.1,1.1-0.4,1.1-0.8c0-0.4,0-1.4,0-2.8
